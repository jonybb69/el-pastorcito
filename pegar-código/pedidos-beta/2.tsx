...
export default function AdminPedidosPage() {
  ...
  body: JSON.stringify({
    clienteId: 1,
    productos: [
      { productoId: 1, cantidad: 2, precio: 30 },
      { productoId: 3, cantidad: 1, precio: 15 },
    ],
  }),
});
      // Simulación de datos para mostrar contenido
      // Elimina esto y usa la respuesta real de tu API en producción
      setPedidos([
        {
          id: 1,
          pedidoId: 1,
          ...
          productos: [
            { id: 1, nombre: 'Pizza', salsas: ['Tomate'], cantidad: 2, precio: 30 },
            { id: 2, nombre: 'Empanada', salsas: [], cantidad: 3, precio: 10 }
          ]
        }
      ])
  ...
  const eliminarPedido = async (id?: number) => {
    ...
    try {
      // Aquí harías la llamada a tu API para eliminar
  ...
  const getEstadoConfig = (estado: string) => {
    return estadosPedido.find(e => e.value === estado) || 
      { value: estado, label: estado, icon: FiPackage, color: 'gray', description: '' }
  }
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <motion.div
        ...
        className={`fixed z-50 left-4 top-4 h-[calc(100vh-2rem)] w-80 bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border border-gray-200/50 flex flex-col ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
            ...
            <motion.button
              ...
              disabled={cargando}
              className={`w-full text-left p-4 rounded-xl bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 transition-all flex items-center gap-3 shadow-md hover:shadow-lg disabled:opacity-50 ${
              ...
              return (
                <motion.button
                  ...
                  className={`w-full text-left p-4 rounded-xl transition-all flex items-center gap-3 shadow-md hover:shadow-lg disabled:opacity-50 ${
                    ...
                    estado.color === 'red' ? 'bg-gradient-to-r from-red-100 to-pink-200 hover:from-red-200 hover:to-pink-300' :
                    estado.color === 'blue' ? 'bg-gradient-to-r from-blue-100 to-cyan-200 hover:from-blue-200 hover:to-cyan-300' :
                    estado.color === 'purple' ? 'bg-gradient-to-r from-purple-100 to-pink-200 hover:from-purple-200 hover:to-pink-300' :
                    'bg-gradient-to-r from-green-100 to-emerald-200 hover:from-green-200 hover:to-emerald-300'
                  }`}
                >
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                    estado.color === 'red' ? 'bg-gradient-to-r from-red-500 to-pink-500' :
                    estado.color === 'blue' ? 'bg-gradient-to-r from-blue-500 to-cyan-500' :
                    estado.color === 'purple' ? 'bg-gradient-to-r from-purple-500 to-pink-500' :
        ...
        <div className="p-6 bg-gray-50 rounded-b-2xl mt-auto">
          <button
            ...
            disabled={cargando || !mostrarContenido}
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                          <div className="text-sm text-gray-600">
                            Total: <span className="font-semibold text-gray-900">${calcularTotal(pedido.productos)}</span>
                          </div>
