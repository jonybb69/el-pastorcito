  ...
  return (
    <section className="max-w-6xl mx-auto mt-10 p-6 text-white">
      <motion.h2
        ...
        className="text-4xl font-extrabold text-yellow-400 mb-12 text-center"
      >
        Pedidos Entrantes
      </motion.h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {pedidos.map((pedido) => (
            <motion.div
              ...
              className="border border-white/10 backdrop-blur-md bg-white/5 rounded-2xl shadow-xl p-6 transition-all hover:border-yellow-400 hover:shadow-yellow-500/20"
            >
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-semibold text-yellow-400">{pedido.numeroPedido}</h3>
